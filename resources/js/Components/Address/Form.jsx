...
export default function Form({
    ...
    return (
        <form onSubmit={onSubmit} className="space-y-6 dark:bg-gray-800 dark:text-white">
            {/* País */}
            <div>
            ...
            <div className="flex items-end gap-4">
                ...
                <button
                    ...
                    className="bg-gray-300 text-gray-800 px-6 py-2 rounded-full hover:bg-gray-400 transition dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500"
                >
                    Verificar
                </button>
            </div>
