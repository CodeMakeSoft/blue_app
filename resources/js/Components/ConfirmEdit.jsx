        ...
        <div className="fixed inset-0 flex justify-center items-center bg-black/20 dark:bg-black/40 z-50">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-2xl p-6 w-full max-w-md border border-gray-200 dark:border-gray-700">
                <div className="flex flex-col items-center mb-6">
                    <PencilSquareIcon className="h-12 w-12 text-gray-500 dark:text-gray-400 mb-4" />
                ...
                <div className="flex justify-center space-x-4">
                    <button
                        ...
                        className="bg-gray-300 dark:bg-gray-700 text-gray-800 dark:text-gray-200 
                            px-6 py-2 rounded-md hover:bg-gray-400 dark:hover:bg-gray-600 
                    ...
                    <button
                        onClick={onConfirm}
                        className="bg-blue-600 dark:bg-blue-500 text-white px-6 py-2 rounded-md 
