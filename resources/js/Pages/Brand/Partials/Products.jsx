...
export default function BrandProducts({ auth, brand, products }) {
                ...
                <div>
                    <Breadcrumb
                        routes={[
                            ...
                            { name: "Marcas", link: route("brand.catalog") },
                        ]}
                    ...
                    <h2 className="text-2xl font-semibold leading-tight text-gray-800 dark:text-gray-200 mt-2 flex items-center gap-2">
                        <FontAwesomeIcon icon={faTrademark} className="text-blue-600 dark:text-blue-500" />
                        {brand.name}
                    </h2>
                </div>
            }
        >
            <Head title={`Productos de ${brand.name}`} />
