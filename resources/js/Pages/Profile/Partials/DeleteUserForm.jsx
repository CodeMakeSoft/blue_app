                ...
                <form onSubmit={deleteUser} className="p-6 bg-white dark:bg-gray-800">
                    ...
                    <div className="mt-6">
                        ...
                        <TextInput
                            ...
                            className="mt-1 block w-3/4 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:ring-red-500 dark:focus:ring-red-600"
                            isFocused
                    ...
                    <div className="mt-6 flex justify-end">
                        ...
                        <DangerButton 
                            className="ms-3 bg-red-600 dark:bg-red-500 hover:bg-red-700 dark:hover:bg-red-600" 
                            disabled={processing}
                        >
                            Delete Account
                        </DangerButton>
